...
def test_high_article_set_includes_phase_template_articles():
    # Art. 50 left every tier set in fix 51: it is conditional on the system
    # type and reaches an engagement through the Stage A gate (finding R18).
    required = {"Art.5", "Art.6", "Art.11", "Art.12", "Art.72", "Annex_IV"}
